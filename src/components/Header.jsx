    ...
    <>
      <header className="bg-navbar" id="home">
        <div className=" mx-auto px-4 py-4 md:py-4 md:justify-between items-center flex-col md:flex-row ">
          ...
          >
            <ul className="h-12  px-8 mt-8 sm:mt-8 md:mt-10 lg:mt-9 xl:mt-8 2xl:mt-8 cursor-pointer flex flex-row  justify-center space-x-4 md:space-x-16 lg:space-x-38 xl:space-x-44 text-gray-700 text-md md:text-xl font-larken uppercase font-bold tracking-wider ">
